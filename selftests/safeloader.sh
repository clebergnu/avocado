...
for PYTHON_FILE in $(grep -c -m1 -E 'import unittest$' selftests/unit/test_*.py selftests/unit/utils/test_*.py selftests/functional/test_*.py | grep -v test_skiptests | grep -v -E ':0$' | cut -d ':' -f 1); do
