...
class ConfigOption:
    ...
    def argparse_type(self):
        # type is automatic when using lists Argparse do not support list
        # on command-line. They are comma separated strings that will be
...
class Settings:
    ...
    def register_option(self, section, key, default, help_msg, key_type=str,
        ...
        This method will take care of the 'under the hood dirty', registering
        the configparse option and, if desired, the argparse too.  Instead of
        using argparse and/or configparser, Avocado' contributors should use
        this method.
    ...
    def update_option(self, namespace, value, convert=False):
        ...
        option.set_value(value, convert)
